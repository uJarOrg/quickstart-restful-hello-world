...
kubectl create clusterrolebinding service-pod-reader-$K8S_NAMESPACE --clusterrole=microservices-kubernetes-namespace-reader --serviceaccount=$K8S_NAMESPACE:$SVC_NAME
